...
depth=8     # Depth of the channel estimation network
...
for epoch in range(epochs):
    for i, input in enumerate(train_loader):
        ...
        index=random.choices(whole_index,k=random.choice(whole_index)+1)   # From a batch of 32 samples, randomly select a subset of random length
        index_now=index[-1]
